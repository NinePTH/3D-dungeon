...
blm_rig_id = "04ne8qrbgic0"


class BLOP_PT_rigui_04ne8qrbgic0(bpy.types.Panel):
	bl_space_type = 'VIEW_3D'
	bl_region_type = 'UI'
	bl_category = 'Item'
	bl_label = "Rig UI"
	bl_idname = "BLOP_PT_rigui_04ne8qrbgic0"
	...
	def draw(self, context):
		...
		row = col.row(align=True)
		row.prop(context.active_object.data,'layers', index=11, toggle=True, text='LEG.L')
		row.prop(context.active_object.data,'layers', index=12, toggle=True, text='LEG.R')

		row = col.row(align=True)
		row.prop(context.active_object.data,'layers', index=13, toggle=True, text='ARM-FK.R')
		row.prop(context.active_object.data,'layers', index=14, toggle=True, text='ARM-FK.L')

		row = col.row(align=True)
		row.prop(context.active_object.data,'layers', index=15, toggle=True, text='ARM-IK.R')
		row.prop(context.active_object.data,'layers', index=16, toggle=True, text='ARM-IK.L')

		row = col.row(align=True)
		row.prop(context.active_object.data,'layers', index=18, toggle=True, text='HANDS')

		row = col.row(align=True)
		row.prop(context.active_object.data,'layers', index=17, toggle=True, text='DRESS')
		row.prop(context.active_object.data,'layers', index=19, toggle=True, text='WEAPON')

		row = col.row(align=True)
		row.prop(context.active_object.data,'layers', index=20, toggle=True, text='FACE')


class BLOP_PT_customprops_04ne8qrbgic0(bpy.types.Panel):
	bl_category = 'Item'
	bl_label = "Rig Properties"
	bl_idname = "BLOP_PT_customprops_04ne8qrbgic0"
	bl_space_type = 'VIEW_3D'
	bl_region_type = 'UI'
...
classes = (BLOP_PT_rigui_04ne8qrbgic0, BLOP_PT_customprops_04ne8qrbgic0, )
